...
def matching_scoring():
    ...
    parser.add_argument('--MS1_offset', default=0, type=int,
                        help='Offset (ppm) to apply to all instances of precursor ions matching')
    parser.add_argument('--MS2_offset', default=0, type=int,
    ...
    match = Match(args.Theoretical_digest, args.Input_mgf, args.isotopic_species, args.MS1_mz_minimum,
                  ...
                  args.MS1_offset,
                  args.MS2_offset, args.MS2_ions_minimum_intensity, args.MS2_most_intense_ions,
