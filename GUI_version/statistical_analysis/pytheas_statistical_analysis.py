...
def statistical_plots():
    ...
    parser.add_argument('--sequence_lengths', default='all',
                        help='Sequence length values to use for plots. Insert the values separated by a comma'
                             '(default = all)')
    ...
    parser.add_argument('--FDR_input', default=None, widget="FileChooser",
                        help='FDR analysis file which is edited based on the statistical options selected')
    ...
    statistics = Stats(args.Targets, args.Decoys, args.Match_output, args.isotopic_species, args.FDR_input,
                       ...
                       args.hide_box_graphs,  args.scatterplot_Sp_vs_dSp, args.scatterbox_length_charge)
