...
sequence-meaningful ions (only  11 main series) withint the specified m/z window
...
class Match:
    def __init__(self, digest, mgf, isotope, MS1_mzmin, MS1_mzmax, MS2_mzmin, MS2_mzmax, MS1_ppm, MS2_ppm,
        ...
        self.MS1_ppm, self.MS2_ppm, self.MS1_ppm_offset = MS1_ppm, MS2_ppm, MS1_offset_ppm
        self.MS2_ppm_offset, self.MS2_peak_int_min, self.MS2_peak_num_max = MS2_offset_ppm, MS2_intensity_min, MS2_peaks_max
    ...
    def normalize_int_MS2(self, mgf_peaks, match_peaks, digest):
        """
        Normalizes the intensity of the matching ions where 100 is the most intense ion excluding M-xx series +
    ...
    def mgf_dic(self):
        ...
        for line in mgf_file:
            ...
            # Sets values for prec_mass, rt and charge in order to avoid errors when those values are missing from
        ...
        for key in d:
            ...
            for k in d[key]:
                if np.float64(k) >= self.MS2_mzlow and np.float64(k) <= self.MS2_mzhigh:
    ...
    def output(self):
        ...
        output_lines.append(
            "#MATCHES_HEADER:m/z(meas) RT(mins) m/z(theo) offset intensity_prec abs_sumI dSp Sp Sp_one length "
            "#MS2_matches light/heavy charge seq mod 3'-end 5'-end MS2_matches-->m/z_measured(offset(ppm))"
            "[norm_intensity]:m/z_theoretical[CID_ion] rank detailed_score\n\n")
            ...
            if ctrl:
                ...
                for ion_rt in match_dic[key]:
                    ...
                    for match in ion_rt[1]:
                        ...
                        calculated_offset = ppm_offset(ion_rt[0].split('_')[0],
    ...
    def final_output(self):
        ...
        # Write an additional csv file to make analysis of the results easier
