...
parser.add_argument('--nts_alphabet', required=True, help='File with nucleotides and modification alphabet ('
                                                          'Required)')
parser.add_argument('--input_file', required=True, help='Final report csv file (Required)')
parser.add_argument('--input_sequences', required=True, help='Original sequence (fasta) used for the in silico '
                                                             'digestion vs which mapping will be performed')
parser.add_argument('--min_length', default=3, type=int, help='Minimum fragment length to be considered in the '
                                                              'mapping score')
parser.add_argument('--Sp_cutoff', default=0, help='Minimum Sp score cutoff for fragments to be considered for '
                                                   'mapping')
...
if __name__ == "__main__":
    ...
    html_lines = [html_css_header(), " ".join(merge_dataframes(transpose_df('mapping_output.csv')))]
